    ...
    <>
      ...
      <div id="section-1" className="flex flex-col items-center justify-center h-screen text-white lg:px-6">
        <div className="lg:p-2">
          ...
          <div className="flex flex-row lg:items-center pb-1">
            ...
            <div className="hidden lg:visible lg:flex space-x-2 lg:space-x-4 mt-4 md:mt-0">
              ...
              <a href="https://www.linkedin.com/in/joao-pedro-do-prado-moretti-891083227/" target="_blank" rel="noopener noreferrer" className="text-[16px] lg:text-[32px] icon-pulse">
                <FaLinkedin />
              </a>
              <a href="mailto:joao.moretti55391@gmail.com" className="text-[16px] lg:text-[32px] icon-pulse">
                <FaEnvelope />
              </a>
            </div>
          </div>
        ...
        <div className="flex lg:hidden space-x-2 lg:space-x-4 pt-12 ">
          <a href="https://github.com/Morettys2" target="_blank" rel="noopener noreferrer" className="text-[26px] icon-pulse">
            <FaGithub />
          </a>
          <a
            href="https://www.linkedin.com/in/joao-pedro-do-prado-moretti-891083227/"
            target="_blank"
          ...
          <a href="mailto:joao.moretti55391@gmail.com" className="text-[26px] icon-pulse">
            <FaEnvelope />
          </a>
        </div>
      </div>
